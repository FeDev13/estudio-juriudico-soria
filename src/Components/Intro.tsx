    ...
    <div className=" mb-10">
      <div className="  flex flex-col w-1/2 mx-auto md:flex-col md:justify-center lg:flex-row">
        <button className="hidden mx-10 lg:flex p-8 rounded-lg bg-gradient-to-r from-finish-blue to-starting-blue ">
          <svg
            ...
            className="icon icon-tabler icon-tabler-phone bg-transparent"
            width="40"
            height="40"
            viewBox="0 0 24 24"
            strokeWidth="2"
          ...
          <p className=" text-black text-lg sm:text-white bg-transparent">
            {datos.slice(0, 1)}
          </p>
        </button>
        <button className=" hidden lg:flex p-8 rounded-lg bg-gradient-to-r from-finish-blue to-starting-blue">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="icon icon-tabler icon-tabler-mail mr-8 bg-transparent"
            width="40"
            height="40"
            viewBox="0 0 24 24"
            strokeWidth="2"
      ...
      <div className=" flex flex-col w-[110%] -ml-20 md:flex-col lg:flex-row mb-8 p-12 mt-24">
        ...
        <div>
          ...
          <p className=" text-xl md:text-left mb-32 w-full p-1 md:w-full md:ml-0 md:text-2xl lg:h-1/2 ">
            {datos.slice(1)}
          </p>
        </div>
      </div>
